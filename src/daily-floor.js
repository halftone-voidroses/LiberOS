...
(function () {
  ...
  var POOL = [
    ...
    { id: 'chat',        room: 'cohort.html',     text: 'speak one honest thing to the chat, and seal it' },
    ...
    { id: 'relation',    room: 'desktop.html',    text: 'bind one kept artifact to the cohort with a verb' }
  ];

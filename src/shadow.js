...
// changes nothing) and cohort-N (artifacts+relations — the cohort becomes
...
// src/prompt-engine.js cohortLevel().
...
(function () {
  ...
  function applyPresence(s) {
    ...
    setTierClass(m, 'cohort-', tierLevel(artifacts + relations, COHORT_TIERS));
  }

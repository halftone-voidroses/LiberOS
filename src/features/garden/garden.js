...
(function () {
  ...
  function scrambleGem() {
    ...
    renderGem();
    renderSlots();
    setNote('the gem is jumbled. settle every facet.');
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var raison = document.getElementById('garden-raison');
    var raisonClose = document.getElementById('garden-raison-close');
    function openRaison() { if (raison) { raison.classList.add('open'); raison.removeAttribute('inert'); } }
    function closeRaison() { if (raison) { raison.classList.remove('open'); raison.setAttribute('inert', ''); } }

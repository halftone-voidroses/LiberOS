...
(function () {
  var CARDS = [
    ...
    },
    {
      ...
      body: 'the Self, in jung\'s sense, is not the ego grown grand. it is the totality of the psyche, conscious and unconscious together, the whole circled by the part that mistakes itself for the whole; aion is the volume where jung works out what that meeting costs the ego<button type="button" class="learn-fn" data-cite="jung-cw9ii" aria-label="citation">†</button>. the archetype volume supplies the working definitions<button type="button" class="learn-fn" data-cite="jung-cw9i" aria-label="citation">†</button>. individuation is the labour of coming to that wholeness, and jung held it to be chiefly the work of the second half of life — after the persona has been built, the world has been met, and the roles have begun to feel like costumes. its symbols arrive unbidden: the mandala, the circle with a centre, the fourfold pattern, the quarternio of sides. the ego\'s job is satellite, not sun. it orbits, it reports, it keeps the ethical watch, and it slowly learns it was never the point. the mandalas drawn in this workbook\'s grounding pages belong to exactly this family of images. anderson states the ethic plain: the Self is a koan — practiced, never scored<button type="button" class="learn-fn" data-cite="anderson-2025-koan" aria-label="citation">†</button>.',

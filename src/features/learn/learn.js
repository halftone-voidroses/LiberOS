...
(function () {
  var CARDS = [
    ...
    {
      num: '15', title: 'Anima and Animus',
      body: 'the anima and animus are the contra-sexual other inside: in a man the anima, the inner woman; in a woman the animus, the inner man. the definitions used here come from the archetype volume<button type="button" class="learn-fn" data-cite="jung-cw9i" aria-label="citation">†</button>. the first meeting is never inside. it is projection: a stranger carries the figure for a season, and the falling is really a landing on someone who stood in the way. jung paired the poles with eros and logos, relation and meaning, each side carrying what the conscious attitude has left untrained. the animus in particular can appear as the crowd of opinions — the chorus of borrowed judgements that speaks in the first person plural and sounds like your own voice. von franz reads the drama in dreams, since dreams tell the inner truth about the dreamer and will cast the figure honestly when asked<button type="button" class="learn-fn" data-cite="von-franz-1964" aria-label="citation">†</button>. the work is the same as shadow work: withdraw the projection, met by met, until the figure comes home and the real person across from you can be seen plain — which is how the personality thickens toward its own totality<button type="button" class="learn-fn" data-cite="jung-cw9ii" aria-label="citation">†</button>.',
      key: 'anima · animus · projection · eros logos'
    },
    {
      num: '16', title: 'Active Imagination',
      body: 'jung wrote the method down in 1916 and called it the transcendent function: the capacity, once the opposites are held long enough, for a third thing to appear<button type="button" class="learn-fn" data-cite="jung-transcendent-1957" aria-label="citation">†</button>. the method is plain to describe and hard to do. invite the image. let it speak. give it ink — on the page, in drawing, in the voice the cohort uses. and keep the ethical ego awake: you are the host of the dialogue, not the audience, and certainly not the prisoner. von franz read the alchemists\' stages, the blackening and the whitening, as the record of this same work, run slow and in glassware, behind the transformation symbols<button type="button" class="learn-fn" data-cite="von-franz-1980" aria-label="citation">†</button>. the cohort dialogue in this workbook is modelled on it exactly: the figures are invited, addressed, answered, then thanked and closed. the danger is named with the method: letting the fantasy take the helm. the fantasy steers; the scribe keeps the wheel.',
      key: 'active imagination · transcendent function · dialogue'
    },
    {
      num: '17', title: 'The Collective Unconscious',
    ...
    {
      num: '18', title: 'The Self and Individuation',
      body: 'the Self, in jung\'s sense, is not the ego grown grand. it is the totality of the psyche, conscious and unconscious together, the whole circled by the part that mistakes itself for the whole; aion is the volume where jung works out what that meeting costs the ego<button type="button" class="learn-fn" data-cite="jung-cw9ii" aria-label="citation">†</button>. the archetype volume supplies the working definitions<button type="button" class="learn-fn" data-cite="jung-cw9i" aria-label="citation">†</button>. individuation is the labour of coming to that wholeness, and jung held it to be chiefly the work of the second half of life — after the persona has been built, the world has been met, and the roles have begun to feel like costumes. its symbols arrive unbidden: the mandala, the circle with a centre, the fourfold pattern, the quarternio of sides. the ego\'s job is satellite, not sun. it orbits, it reports, it keeps the ethical watch, and it slowly learns it was never the point. the mandalas drawn in this workbook\'s grounding pages belong to exactly this family of images.',
      key: 'Self · individuation · mandala · second half of life'
    },
    {
      num: '19', title: 'Fairy Tales and the Shadow',
    ...
    {
      num: '20', title: 'The Inner Household',
      body: 'two analysts mapped the household inside. klein drew the inner world as peopled: the people of your life, taken in whole, live on inside as objects with moods and agendas, and the cohort here is read as inner object rather than as metaphor<button type="button" class="learn-fn" data-cite="klein-1932" aria-label="citation">†</button>. winnicott found the door between the worlds: the transitional object — the blanket, the teddy, the first not-me possession — the thing that is neither me nor quite the world, and by being both opens an intermediate zone where playing, keeping, and the first culture happen<button type="button" class="learn-fn" data-cite="winnicott-1953" aria-label="citation">†</button>. the satchel lives in that zone. its kept artifacts — the sigils, the gem drafts, the seeds from the garden — are transitional objects in the strict sense: held between inner and outer, worthless to anyone else, load-bearing for the keeper. the workbook is a household because the things in it are kept, and keeping is the oldest intermediate act there is.',

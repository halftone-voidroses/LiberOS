...
(function () {
  ...
  function playTipp(b, body) {
    ...
    if (keep) keep.addEventListener('click', function () {
      ...
      promptSave(b, 'walked the floor: ' + names.join(', ') + '.', function () {
        saveToDesktopAndSatchel(b, { skills: steps }, tippShot(ratings));
  ...
  function renderPlay(b, body) {
    ...
    if (b.id === 'tipp') return playTipp(b, body);
  }
